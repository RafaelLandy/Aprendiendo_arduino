// ESTE PROGRAMA ES PARA CAMBIAR NOMBRE Y CODIGO A MODULO BLUETHOO HC 06 TOMADO DE https://www.youtube.com/watch?v=r6pSj6jFmvc . Funciono muy bien con arduino mega 19_Agosto_2020
...
/* Programa el modulo bluetooth HC-06 con un nuevo: 
  ...
  5V        VCC
  GND       GND
  PIN 2     TX HAy que hacer las conexiones como se indica sin cruzar
  PIN 3     RX
...
char NOMBRE[21]  = "HC-05 Dinastia_Tec"; // Nombre de 20 caracteres maximo
